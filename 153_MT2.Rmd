...
```{r}
writeData <- function(dataset, q.num, firstname, lastname, SID, optional = NULL) {
  output <- write.table(dataset,
            ...
            file = paste0("Q",q.num,"_",
                          firstname,"_",
                          lastname,"_",SID, optional,".txt"))
  return(output)
}

writeData(predictions6, q.num = 1, "Samba", "Njie", 23075185,"pred6")
writeData(predictions7, q.num = 1, "Samba", "Njie", 23075185,"pred7")
